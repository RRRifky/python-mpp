...
Button(app, text='Exit', command=tombol_exit, foreground='white', bg='#ff1e1e', width=10).place(x=400, y=400)

# footer text
Label(app, bg='#31c6d4', foreground='#fef5ac', font='arial 10 ').place(x=300,y=550)
